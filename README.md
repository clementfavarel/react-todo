...
This is a simple todo app that I made to learn React.
You can add, delete and mark as done your todos.

## How to use

1. Add a new todo by typing it in the input field and pressing enter
2. Delete a todo by clicking on the trash icon
3. Mark a todo as done by clicking on the check icon
4. Filter your todos by clicking on the buttons at the top of the page

## Author

-   [clementfavarel](https://github.com/clementfavarel)
